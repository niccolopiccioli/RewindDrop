/** Curated Unsplash URLs for demo / seed data (streetwear & apparel). */
...
export const CATEGORY_IMAGES = {
  ...
  pantaloni: unsplash("photo-1542272604-787c3835535d"),
  cappelli: unsplash("photo-1588850561407-ed78c282e89b"),
  borse: unsplash("photo-1553062407-98eeb64c6a62"),
  giacche: unsplash("photo-1591047139829-d91aecb6caea"),
} as const;

export type CategoryImageKey = keyof typeof CATEGORY_IMAGES;

export const EDITORIAL_IMAGES = {
  felpe: CATEGORY_IMAGES.felpe,
  tShirts: CATEGORY_IMAGES["t-shirts"],
  giacche: CATEGORY_IMAGES.giacche,
  lookbook: unsplash("photo-1515886657613-9f3515b0c78f", 1200),
  details: unsplash("photo-1483985988355-763728e1935b", 1200),
} as const;

const PRODUCT_POOL: Record<CategoryImageKey, string[]> = {
  "t-shirts": [
    ...
    unsplash("photo-1618354691373-d851c5c3f990", 900),
  ],
  felpe: [
    ...
    unsplash("photo-1503341504253-dff4815485f1", 900),
  ],
  pantaloni: [
  ...
  giacche: [
    ...
    unsplash("photo-1594938298603-c8148c4dae35", 900),
